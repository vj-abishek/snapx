...
export default function Controls({
  ...
  return (
    <div className="mt-5 flex w-full items-center justify-center text-xs">
      <div className="flex flex-row items-center gap-5 rounded-full bg-primary-200 px-7 py-2 shadow-xl sm:px-7 sm:py-3">
        <div
        ...
        <button
          ...
          disabled={frame.includes(Frame.NoFrame)}
        >
